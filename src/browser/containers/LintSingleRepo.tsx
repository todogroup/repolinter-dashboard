...
public renderRadioButtons=()=>{
 return(
 	<div>
 		<h4><a href="https://github.com/todogroup/repolinter#rules">Ruleset</a> Type:</h4>
 		<div className="form-check">
		  	<input className="form-check-input" type="radio" name="rulesetType" value="default" onChange={this.handleRadioButtons} defaultChecked={true}/>
		  	<label className="form-check-label">
		    Default 
		 	</label>
        &emsp; &emsp;
		  	<input className="form-check-input" type="radio" name="rulesetType"  value="custom" onChange={this.handleRadioButtons} />
		  	<label className="form-check-label">
		    Custom 
		 	</label>
		</div>
...
public render(){
 return(
	...
	<div className="input-group mb-3">
  	<input type="text" className="form-control" placeholder="Repository Url" onChange={this.updateGitLink} required={true}/>
  	<div className="input-group-append">
    <button className="btn btn-outline-secondary" type="button" onClick={this.handleScan}>Scan</button>
  	</div>
	</div>
	</div>
  ...
  {this.renderRadioButtons()}
    ...
    <div className="col-7">
    {this.state.resultView && <ResultViewer result={this.state.scanData}/>}
    </div>
    </div>
  </div>
	</div>
